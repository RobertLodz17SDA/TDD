...
public class AlgorithmsTest {
    ...
    public void testBigFibonacciBeginning() {
        assertEquals(new BigInteger("0"), sut.bigFibonacci(BigInteger.valueOf(0)));
        assertEquals(new BigInteger("1"), sut.bigFibonacci(BigInteger.valueOf(1)));
        assertEquals(new BigInteger("1"), sut.bigFibonacci(BigInteger.valueOf(2)));
        assertEquals(new BigInteger("2"), sut.bigFibonacci(BigInteger.valueOf(3)));
        assertEquals(new BigInteger("3"), sut.bigFibonacci(BigInteger.valueOf(4)));
        assertEquals(new BigInteger("5"), sut.bigFibonacci(BigInteger.valueOf(5)));
        assertEquals(new BigInteger("8"), sut.bigFibonacci(BigInteger.valueOf(6)));
    }

    @Test
    public void testBigFibonacciFurther() {
        assertEquals(new BigInteger("12586269025"), sut.bigFibonacci(BigInteger.valueOf(50)));
        assertEquals(new BigInteger("354224848179261915075"), sut.bigFibonacci(BigInteger.valueOf(100)));
        final BigInteger expected = new BigInteger(
                "43466557686937456435688527675040625802564660517371780402481729089536555417949051890403879840079255169295922593080322634775209689623239873322471161642996440906533187938298969649928516003704476137795166849228875");
        assertEquals(expected, sut.bigFibonacci(BigInteger.valueOf(1000)));
    }
    ...
    public void boundaryTestBigFibonacci() {
        sut.bigFibonacci(BigInteger.valueOf(-1));
    }
